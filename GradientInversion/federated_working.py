# -*- coding: utf-8 -*-
"""federated_working.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/105aZAEFa4e5cWg1-kl_Q9p82r33V5Hlj
"""
...
for r in range(num_rounds):
    ...
    for i in tqdm(range(num_selected)):
        ...
        if client_idx[i] == 3:
            ...
            gradinversion = GradientInversion_Attack(client_models[i], img_shape, num_iteration=200,
